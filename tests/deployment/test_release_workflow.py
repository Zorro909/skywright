...
class ReleaseWorkflowTest(unittest.TestCase):
    def test_release_builds_renders_publishes_and_attests_one_commit(self) -> None:
        ...
        self.assertIn("Build main deployment images", workflow)
        ...
        self.assertIn("release-support shared-skypilot-version", workflow)
        self.assertIn("release-support finalize-build-artifacts", workflow)
